...
alpha_text = lerp(alpha_text, target_alpha, 0.1); // Ajusta la velocidad del fade si es necesario

if (alpha_text > 0.05) { // Solo dibujamos si hay algo visible
    // Variables para el texto
    var text = "";
    if (room == Room1_Outside) {
        text = "Presiona E para usar la puerta";
    } else {
        text = "E para abrir puerta";
    }
    
    var padding = 6;
    var base_alpha = 0.8;

    // Configurar la fuente y alineación del texto
